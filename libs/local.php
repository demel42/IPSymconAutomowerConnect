...
trait AutomowerConnectLocalLib
{
    ...
    public static $IS_FORBIDDEN = IS_EBASE + 15;
    public static $IS_INVALIDACCOUNT = IS_EBASE + 16;
    public static $IS_DEVICE_MISSING = IS_EBASE + 17;
    ...
    public function InstallVarProfiles(bool $reInstall = false)
    {
        ...
        $associations[] = ['Wert' => 91, 'Name' => $this->Translate('Switch cord problem'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 92, 'Name' => $this->Translate('Work area not valid'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 93, 'Name' => $this->Translate('No accurate position from satellites'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 94, 'Name' => $this->Translate('Reference station communication problem'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 95, 'Name' => $this->Translate('Folding sensor activated'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 96, 'Name' => $this->Translate('Right brush motor overloaded'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 97, 'Name' => $this->Translate('Left brush motor overloaded'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 98, 'Name' => $this->Translate('Ultrasonic Sensor 1 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 99, 'Name' => $this->Translate('Ultrasonic Sensor 2 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 100, 'Name' => $this->Translate('Ultrasonic Sensor 3 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 101, 'Name' => $this->Translate('Ultrasonic Sensor 4 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 102, 'Name' => $this->Translate('Cutting drive motor 1 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 103, 'Name' => $this->Translate('Cutting drive motor 2 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 104, 'Name' => $this->Translate('Cutting drive motor 3 defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 105, 'Name' => $this->Translate('Lift Sensor defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 106, 'Name' => $this->Translate('Collision sensor defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 107, 'Name' => $this->Translate('Docking sensor defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 108, 'Name' => $this->Translate('Folding cutting deck sensor defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 109, 'Name' => $this->Translate('Loop sensor defect'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 110, 'Name' => $this->Translate('Collision sensor error'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 111, 'Name' => $this->Translate('No confirmed position'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 112, 'Name' => $this->Translate('Cutting system major imbalance'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 113, 'Name' => $this->Translate('Complex working area'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 114, 'Name' => $this->Translate('Too high discharge current'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 115, 'Name' => $this->Translate('Too high internal current'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 116, 'Name' => $this->Translate('High charging power loss'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 117, 'Name' => $this->Translate('High internal power loss'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 118, 'Name' => $this->Translate('Charging system problem'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 119, 'Name' => $this->Translate('Zone generator problem'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 120, 'Name' => $this->Translate('Internal voltage error'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 121, 'Name' => $this->Translate('High internal temerature'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 122, 'Name' => $this->Translate('CAN error'), 'Farbe' => 0xFF0000];
        $associations[] = ['Wert' => 123, 'Name' => $this->Translate('Destination not reachable'), 'Farbe' => 0xFF0000];
